...
--> statement-breakpoint
CREATE TABLE "craftsman_locations" (
	"id" text PRIMARY KEY NOT NULL,
...
ALTER TABLE "complaints" ADD CONSTRAINT "complaints_against_user_id_users_id_fk" FOREIGN KEY ("against_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "craftsman_locations" ADD CONSTRAINT "craftsman_locations_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "craftsman_profiles" ADD CONSTRAINT "craftsman_profiles_reviewed_by_users_id_fk" FOREIGN KEY ("reviewed_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "orders" ADD CONSTRAINT "orders_craftsman_id_users_id_fk" FOREIGN KEY ("craftsman_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_craftsman_id_users_id_fk" FOREIGN KEY ("craftsman_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;