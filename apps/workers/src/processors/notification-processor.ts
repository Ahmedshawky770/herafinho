...
const EMAIL_QUEUE_NAME = 'herafino-emails';
...
export function createEmailWorker(emailService: EmailServiceLike): Worker {
  const worker = new Worker(
    EMAIL_QUEUE_NAME,
    async (job: { data: EmailJobData; id?: string | number }) => {
