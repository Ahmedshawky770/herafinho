...
export const craftsmanProfiles = pgTable('craftsman_profiles', {
    ...
    transportType: text('transport_type', {
        ...
        .notNull()
        .default('bike'),
    transportPhotos: jsonb('transport_photos').$type(),
...
export const complaints = pgTable('complaints', {
    ...
    description: text('description').notNull(),
    evidenceUrls: jsonb('evidence_urls').$type(),
...
// Indexes - to be added via raw SQL migration
// create index idx_craftsman_profiles_status_craft on craftsman_profiles(status, craft_type) where status = 'approved';
